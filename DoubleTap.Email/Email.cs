...
namespace DoubleTap.Email
{
    public class Email
    {
        [NotNull] private readonly Func<Email, Task> _sendAsync;
        ...
        [CanBeNull] public string From { get; }
        [NotNull] public string[] To { get; }
        [CanBeNull] public string Subject { get; }
        [NotNull] public string Body { get; }
        [NotNull] public IReadOnlyList<Attachment> Attachments { get; }
